...
public class DistrictHospitalBeds {
    ...
    public DistrictHospitalBeds(long id, Date oldestReportedAt, Date newestReportedAt, Date publishedOn, District district, int capacityAll, int freeAll, int capacityCovid, int occupiedJisCovid, int occupiedOaimCovid, int occupiedO2Covid, int occupiedOtherCovid, Date updatedAt) {
        this.id = id;
    ...
    public DistrictHospitalBeds(long id) {
        this.id = id;
    }
