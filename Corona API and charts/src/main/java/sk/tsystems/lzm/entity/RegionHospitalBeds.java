...
public class RegionHospitalBeds {
    ...
    public RegionHospitalBeds(long id, Date oldestReportedAt, Date newestReportedAt, Date publishedOn, Region region, int capacityAll, int freeAll, int capacityCovid, int occupiedJisCovid, int occupiedOaimCovid, int occupiedO2Covid, int occupiedOtherCovid, Date updatedAt) {
        this.id = id;
    ...
    public RegionHospitalBeds(long id) {
        this.id = id;
    }
