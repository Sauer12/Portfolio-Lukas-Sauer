...
public class SlovakiaVaccinations {
    ...
    public SlovakiaVaccinations(String id, int dose1Count, int dose2Count, int dose1Sum, int dose2Sum, Date updatedAt, Date publishedOn) {
        this.id = id;
    ...
    public SlovakiaVaccinations(String id) {
        this.id = id;
    }
