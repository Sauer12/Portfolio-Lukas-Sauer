...
public class Theatre {
    ...
    private String theathreName;
    private int seatsPerRow;
    public NavigableSet<Seat> seats;

    public Theatre(String theathreName, int rows, int totalSeats) {
    ...
    public void printSeatMap(){
        ...
        System.out.printf("%1$s%n%2$s Seat Map%n%1$s%n", separatorLine, theathreName);
