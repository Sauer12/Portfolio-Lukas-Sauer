...
public class SlovakiaHospitalPatients {
    ...
    public SlovakiaHospitalPatients(long id, Date oldestReportedAt, Date newestReportedAt, Date publishedOn, int ventilatedCovid, int nonCovid, int confirmedCovid, int suspectedCovid, Date updatedAt) {
        this.id = id;
    ...
    public SlovakiaHospitalPatients(long id) {
        this.id = id;
    }
